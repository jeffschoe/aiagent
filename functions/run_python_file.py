    ...
    parameters=types.Schema(
        ...
        properties={
            ...
            "args": types.Schema(
                ...
                items= types.Schema(
                    type=types.Type.STRING,
                    description="Each optional argument to pass to the Python file being run.",
                ),
                description="The collection of optional arguments to pass to the Python file being run.",
            ), 
        },
        required=["file_path"],
    ),
